...
* @des 波动一致性和SOC的对应关系
* @author  liwenjie
* @date 2019/10/18  13:09
*/
public class FluctuatingConsistencyAndSOCMain {
    //读取文件地址
...
//        readFile();
//        outCsv("LHB15T3E0JG404306波动性检测模型单体异常次数与SOC对应关系最近一周.csv");
//        out3D();
        List<String> Y = Arrays.asList("'2','8','13','14','16','25','36','44','63','73','76'".split(","));
        System.out.println(Y.get(9));
    ...
    public static Map<Integer, Map<String, Integer>> readFile() {
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                Integer soc = (Integer.parseInt(item[5])+Integer.parseInt(item[6]))/2/10;
                if (map.containsKey(soc*10)) {
                    stringIntegerMap = map.get(soc*10);
                ...
                map.put(soc*10,stringIntegerMap);
            }
            /*for (Map.Entry<Integer, Map<String, Integer>> integerMapEntry : map.entrySet()) {
                for (Map.Entry<String, Integer> stringIntegerEntry : integerMapEntry.getValue().entrySet()) {
     ...
     * @result  void
     */
    public static List<String> outXY(){
    ...
    public static void outZ(){
        ...
        List<String> X = Arrays.asList("'30','40','50','60','70','80','90'".split(","));
        List<String> Y = Arrays.asList("'2','8','13','14','16','25','36','44','63','73','76'".split(","));
        boolean b = false;
        for (Map.Entry<Integer, Map<String, Integer>> integerMapEntry : map.entrySet()) {
            for (Map.Entry<String, Integer> stringIntegerEntry : integerMapEntry.getValue().entrySet()) {
