...
public class FileDecompressUtils {

    private static Logger LOG = LoggerFactory.getLogger(FileDecompressUtils.class);
    ...
    public static void main(String[] args) {
        try {
            decompressTarGz(new File("/Users/liwenjie/Downloads/13.tar.gz"), "/Users/liwenjie/Downloads/vehData/vehOut/zipOut/");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
