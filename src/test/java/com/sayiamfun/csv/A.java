...
public class A {
    ...
    public static void main(String[] args) {
        String sv = "EJQQiRCQEJMQkBCWEJYQkRCUEJIQkhCUEI4QkRCUEI8QlBCUEJMQkRCPEJIQlhCQEJQQkxCVEJIQmBCPEJAQjRCTEJEQjBCOEI0QjxCNEJEQiBCQEI4QihCMEIwQkBCJEI0QjxCNEJIQkBCMEI4QkRCOEJAQkhCWEJMQkRCUEJEQkRCTEJMQkBCPEJMQlhCZEJUQlRCJEJYQlhCYEJQQmBCREIoQkBCPEI0QlxCUEJIQmBCREJgQkhCVEJUQlA==";
        if (null != sv) {
